...
flags.DEFINE_integer('hidden1_units', 1000,
...
flags.DEFINE_integer('finetuning_epochs', 2,
...
# Directories
flags.DEFINE_string('train_data_dir', home_out('PycharmProjects/AnomalyDetection/UCSD/UCSDped1/train/train_feature'),
                    'Directory to put the training data.')

flags.DEFINE_string('test_data_dir', home_out('PycharmProjects/AnomalyDetection/UCSD/UCSDped1/test/test_feature'),
                    'Directory to put the testing data.')
