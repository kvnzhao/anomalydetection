...
for i in range(176):
    patch = i
    ucsd = inputdata.read_data_sets(train_data_dir, test_data_dir, patch)
    ...
    with tf.Session() as sess:
        ...
        np.save('/home/kun/data/UCSD/UCSDped1/Train/train203_encoder_feature/train_encoder_patch_%d.npy' % patch, output_train_encoder)
        ...
        np.save('/home/kun/data/UCSD/UCSDped1/Test/test203_encoder_feature/test_encoder_patch_%d.npy' % patch, output_test_encoder)
